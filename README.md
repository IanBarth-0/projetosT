...
<body>
    ...
    <div class="barraDePesquisa">
        <p><strong>Pesquisar por nome:</strong></p>
        <input type="text" placeholder="Título do livro">

        <p><strong>Selecione por Tipo:</strong></p>
    <div class="procuraPorTipo">
        <button class="listaTipo" id="tipos">
        <span id="TipoSelecionado">Selecione o tipo</span>
        <span class="seta">▼</span>
</button>
    <div class="opcoesTipo" id="menuProcuraPorTipo">
        <div class="opcao-customizada" data-valor="fc">Ficção Científica (FC)</div>
        <div class="opcao-customizada" data-valor="ro">Romance (RO)</div>
        <div class="opcao-customizada" data-valor="dc">Divulgação Científica (DC)</div>
    </div>
</div>
</div>
    ...
    <img src="neuromancerCapa.jpg" alt="capaNeuromancer">
</a>
